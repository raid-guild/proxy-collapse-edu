/**
 * Proxy Collapse — interactive comic book content model.
 *
...
export const SPREADS: ComicSpread[] = [
  {
    id: "cover",
    kind: "cover",
    title: "Proxy Collapse",
    image: "/comic/pages/cover.jpg",
  },
  {
    id: "bridge-1",
    kind: "bridge",
    ...
    hotspots: [
      {
        ...
        ...framedCell(0, 0),
        image: "/comic/panels/page1/gatekepper-pile-resumes.jpg",
      },
      {
        id: "p1-2",
        ...
        ...framedCell(1, 0),
        image: "/comic/panels/page1/nerveous-initiate.jpg",
      },
      {
        id: "p1-3",
        ...
        ...framedCell(2, 0),
        image: "/comic/panels/page1/laptop.jpg",
      },
      {
        id: "p1-4",
        label: "Hand-off",
        ...
        ...framedCell(0, 1),
        image: "/comic/panels/page1/handoff.jpg",
      },
      {
        id: "p1-5",
        ...
        ...framedCell(1, 1),
        image: "/comic/panels/page1/gatekeeper-reading-resume.jpg",
        video: "/comic/videos/gatekeeper-frustrated.mp4",
      },
      {
        id: "p1-6",
        label: "Relief",
        ...
        ...framedCell(2, 1),
        image: "/comic/panels/page1/happy-initiate.jpg",
      },
      {
        id: "p1-7",
        label: "AI tells",
        ...
        ...framedTall(0),
        image: "/comic/panels/page1/aitells.jpg",
      },
      {
        id: "p1-8",
        label: "Caught",
        ...
        ...framedTall(1),
        image: "/comic/panels/page1/shrgging-initiate.jpg",
      },
    ],
  },
  {
    ...
    hotspots: [
      {
        ...
        ...framedCell(0, 0),
        image: "/comic/panels/page2/1-old-ways.png",
        video: "/comic/videos/hot-coals.mp4",
      },
      {
        id: "p2-2",
        label: "Stepping on",
        ...
        ...framedCell(1, 0),
        image: "/comic/panels/page2/2-stepping-on.png",
        video: "/comic/videos/stepping-on.mp4",
      },
      {
        id: "p2-3",
        label: "Owie!",
        ...
        ...framedCell(2, 0),
        image: "/comic/panels/page2/3-owie.png",
        video: "/comic/videos/hopping-owie.mp4",
      },
      {
        id: "p2-4",
        ...
        ...framedCell(0, 1),
        image: "/comic/panels/page2/4-hand-over-box.png",
      },
      {
        id: "p2-5",
        ...
        ...framedCell(1, 1),
        image: "/comic/panels/page2/5-hand-in-box.png",
        video: "/comic/videos/hand-in-box.mp4",
      },
      {
        id: "p2-6",
        label: "Raised brand",
        ...
        ...framedCell(2, 1),
        image: "/comic/panels/page2/6-raised-brand.png",
      },
      {
        id: "p2-7",
        ...
        ...framedTall(0),
        image: "/comic/panels/page2/7-brand-that-tickels.png",
        video: "/comic/videos/brand-tickels.mp4",
      },
      {
        id: "p2-8",
        label: "Hood descends",
        ...
        ...framedTall(1),
        image: "/comic/panels/page2/hood-triptych.jpg",
        video: "/comic/videos/hood-goes-on.mp4",
      },
    ],
  },
  {
    ...
    hotspots: [
      {
        ...
        ...page3Top(0),
        image: "/comic/panels/page3/04-oral-defense.jpg",
      },
      {
        id: "p3-2",
        ...
        ...page3Top(1),
        image: "/comic/panels/page3/05-live-ai-collab.jpg",
      },
      {
        id: "p3-3",
        label: "Think-aloud",
        ...
        ...page3Top(2),
        image: "/comic/panels/page3/06-think-aloud.jpg",
      },
      {
        id: "p3-4",
        ...
        ...page3Bot(0),
        image: "/comic/panels/page3/07-witnessed-process.jpg",
      },
      {
        id: "p3-5",
        label: "A fairer test",
        ...
        ...page3Bot(1),
        image: "/comic/panels/page3/08-redesign-close.jpg",
      },
    ],
  },
  {
